**Mary "7" Laswell: DemiDemon (SuccuCatgirl), 26, Master Programmer - Admiral of the Cypher**
...
**Background:**
- Subjected to experimental hybridization from birth
- Adopted after experiments concluded and raised in civilian stability
- Discovered passion for programming during adolescence
- Achieved prodigious skill in hacking and systems infiltration
- Equipped entire squad with advanced monitoring systems (including bathroom surveillance)

**Armor:**
- ODST Battle Armor (All black with green digital accents)
- Integrated wrist computer for squad systems control and monitoring

**Primary Weapons:**
- Data Knife (specialized electronic warfare blade)
- Anima Works Smart Pistol MK5

**Special Equipment:**
- Military-grade hacking suite
- Integrated wrist computer with squad armor controls
- Advanced surveillance and monitoring systems
- Personal AI companion (integrated into armor systems)
- A key part in the UCG's Mech research division

**Note:** Owns a beaver on weekends
