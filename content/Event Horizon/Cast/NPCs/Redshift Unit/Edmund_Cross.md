...
- 15+ years combat and security experience
- Personally recruited by Niko to Redshift Unit
- Known for his zero-tolerance approach to tactical oversights
- Maintains extensive intelligence networks from his Red Sun days

**Armor:**
- Custom tactical combat suit (black with grey accents)
- Reinforced plating at vital points without full ODST bulk
- Integrated communications system and targeting assist
- Discrete armor panels designed for covert operations

**Primary Weapon:**
- Anima Works Assault Rifle with tactical configuration
- Custom scope and modular attachment system

**Sidearm:**
- Anima Works Smart Pistol MK5

**Special Equipment:**
- Advanced threat assessment scanner
- Encrypted communication array
- Field medical supplies
- Security override kit

**Special Notes:**
- His Red Sun past is both a resource and a constant reminder of the cost of extremism
- He has a mohawk under his helmet, and wears a balaclava similar to Malice's but with the top cut off